 ...
 * @author ACER
 */
public class ViewAllPatientsAdmin extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllPatientsAdmin
     */
    private DefaultTableModel model;
    public ViewAllPatientsAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllPatientsAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllPatientsAdmin().setVisible(true);
            }
        });
    }
